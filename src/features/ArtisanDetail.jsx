        ...
        {artisan && (
          <>
            <Modal xtraclass={''} hidden={toggleModel}>
              ...
              <button className='absolute top-0 right-0 bottom-0 text-xl' onClick={handleModelToggle}>x</button>
              </div>
            ...
            <article className="my-2">
              ...
              {artisan.first_name && artisan.last_name ? `${artisan.first_name} ${artisan.last_name}` : "Not Available"}
              </p>
              <p>
           ...
           <section className='flex'>
              <button onClick={handleReview} className='m-1 bg-black text-sm text-white py-2 rounded-full px-4'>Rate</button>
              <button className='m-1 bg-black text-sm text-white py-2 rounded-full px-4'>Review</button>
            </section>
            )}
          </>
        )}
